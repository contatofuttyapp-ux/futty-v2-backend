...
test('DELETE /api/me sem confirmacao -> 400, conta continua existindo', async () => {
...
test('DELETE /api/me com confirmacao correta -> 200, e o mesmo token passa a dar 401', async () => {
